        ...
        template: {
            return {
                file_header: [
                    ...
                    "; please post to the issue tracker of this repository or send an email to <k.kanryu@gmail.com>.",
                    "; ",
        ...
        template: {
            return {
                file_header: [
                    ...
                    "; You can post to the issue tracker of this repository or send an email to <k.kanryu@gmail.com>.",
                    "; ",
