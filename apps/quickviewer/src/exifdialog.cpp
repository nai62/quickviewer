...
QString ExifDialog::generateFlash(char flash)
{
    ...
    case 0x0000:
        return notflash;
    case 0x0001:
        return tr("Flash fired", "JPEG EXIF Flash setting value (0x1)");
    case 0x0005:
        return tr("Strobe return light not detected", "JPEG EXIF Flash setting value (0x5)");
    case 0x0007:
        return tr("Strobe return light detected", "JPEG EXIF Flash setting value (0x7)");
    case 0x0009:
...
QString ExifDialog::generateOrientation(unsigned short orient)
{
    ...
    case 1:
        return normal;
    case 2:
        return tr("Mirror horizontal", "JPEG EXIF Orientation of the main body of the camera(2)");
    case 3:
        return tr("Rotate 180", "JPEG EXIF Orientation of the main body of the camera(3)");
    case 4:
...
void ExifDialog::setExif(const ImageContent &content)
{
    ...
    meta.addContent(tr("Bits per sample"), info.BitsPerSample);
    ...
    meta.addContent(tr("Date/time original"), QString::fromStdString(info.DateTimeOriginal));
    meta.addContent(tr("Date/time digitized"), QString::fromStdString(info.DateTimeDigitized));
    meta.addContent(tr("Subsecond time original"), QString::fromStdString(info.SubSecTimeOriginal));
    meta.addContent(tr("Exposure time"), info.ExposureTime);
    meta.addContent(tr("F-number"), info.FNumber);
    meta.addContent(tr("ISO speed"), info.ISOSpeedRatings);
    meta.addContent(tr("Shutter speed"), info.ShutterSpeedValue);
    meta.addContent(tr("Exposure bias"), info.ExposureBiasValue);
