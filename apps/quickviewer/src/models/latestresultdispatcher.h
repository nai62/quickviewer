...
public:
    ...
    RequestId submit(const QFuture<T> &future, ResultHandler apply, ResultHandler discard)
    {
    ...
    bool isCurrent(RequestId requestId) const { return requestId == m_requestId; }
