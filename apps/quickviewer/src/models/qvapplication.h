...
class QVApplication : public QApplication
{
    ...
    Q_PROPERTY(
        bool ProhibitMultipleRunning READ ProhibitMultipleRunning WRITE setProhibitMultipleRunning)
    // Bookmark
    ...
    Q_PROPERTY(bool DontEnlargeSmallImagesOnFitting READ DontEnlargeSmallImagesOnFitting WRITE
                   setDontEnlargeSmallImagesOnFitting)
    Q_PROPERTY(bool ShowFullscreenSignage READ ShowFullscreenSignage WRITE setShowFullscreenSignage)
    Q_PROPERTY(
        bool DontShrinkForLargeImage READ DontShrinkForLargeImage WRITE setDontShrinkForLargeImage)
    ...
    Q_PROPERTY(bool WideImageAsOnePageInDualView READ WideImageAsOnePageInDualView WRITE
                   setWideImageAsOnePageInDualView)
    Q_PROPERTY(bool FirstImageAsOnePageInDualView READ FirstImageAsOnePageInDualView WRITE
                   setFirstImageAsOnePageInDualView)
    ...
    Q_PROPERTY(
        bool OpenVolumeWithProgress READ OpenVolumeWithProgress WRITE setOpenVolumeWithProgress)
    Q_PROPERTY(bool ShowReadProgress READ ShowReadProgress WRITE setShowReadProgress)

    // Catalog
    Q_PROPERTY(qvEnums::CatalogViewMode CatalogViewModeSetting READ CatalogViewModeSetting WRITE
                   setCatalogViewModeSetting)
    Q_PROPERTY(QString CatalogDatabasePath READ CatalogDatabasePath WRITE setCatalogDatabasePath)
    Q_PROPERTY(
        int MaxSearchByCharChanged READ MaxSearchByCharChanged WRITE setMaxSearchByCharChanged)
    ...
    Q_PROPERTY(
        bool SearchTitleWithOptions READ SearchTitleWithOptions WRITE setSearchTitleWithOptions)
...
public:
    ...
    void setDontEnlargeSmallImagesOnFitting(bool dontEnlargeSmallImagesOnFitting)
    {
    ...
    void setSvgLoaderBackend(qvEnums::SvgLoaderBackend backend) { m_svgLoaderBackend = backend; }
    int SvgRasterMaximumWidth() { return m_svgRasterMaximumWidth; }
    void setSvgRasterMaximumWidth(int width);
    int SvgRasterMaximumHeight() { return m_svgRasterMaximumHeight; }
    void setSvgRasterMaximumHeight(int height);
    ...
    void setUseCheckeredPattern(bool useCheckeredPattern)
    {
        m_useCheckeredPattern = useCheckeredPattern;
    }
    bool ShowFullscreenSignage() { return m_showFullscreenSignage; }
    void setShowFullscreenSignage(bool showFullscreenSignage)
    {
        m_showFullscreenSignage = showFullscreenSignage;
    }
    bool DontShrinkForLargeImage() { return m_dontShrinkForLargeImage; }
    void setDontShrinkForLargeImage(bool dontShrinkForLargeImage)
    {
        m_dontShrinkForLargeImage = dontShrinkForLargeImage;
    }
    ...
    void setShowPanelSeparateWindow(bool showPanelSeparateWindow)
    {
        m_showPanelSeparateWindow = showPanelSeparateWindow;
    }
    ...
    void setHideMenuBarParmanently(bool hideMenuBarParmanently)
    {
        m_hideMenuBarParmanently = hideMenuBarParmanently;
    }
    bool HideToolBarParmanently() { return m_hideToolBarParmanently; }
    void setHideToolBarParmanently(bool hideToolBarParmanently)
    {
        m_hideToolBarParmanently = hideToolBarParmanently;
    }
    bool HidePageBarParmanently() { return m_hidePageBarParmanently; }
    void setHidePageBarParmanently(bool hidePageBarParmanently)
    {
        m_hidePageBarParmanently = hidePageBarParmanently;
    }

    bool HideMenuBarInFullscreen() { return m_hideMenuBarInFullscreen; }
    void setHideMenuBarInFullscreen(bool hideMenuBarInFullscreen)
    {
        m_hideMenuBarInFullscreen = hideMenuBarInFullscreen;
    }
    bool HideToolBarInFullscreen() { return m_hideToolBarInFullscreen; }
    void setHideToolBarInFullscreen(bool hideToolBarInFullscreen)
    {
        m_hideToolBarInFullscreen = hideToolBarInFullscreen;
    }
    bool HidePageBarInFullscreen() { return m_hidePageBarInFullscreen; }
    void setHidePageBarInFullscreen(bool hidePageBarInFullscreen)
    {
        m_hidePageBarInFullscreen = hidePageBarInFullscreen;
    }
    bool HideScrollBarInFullscreen() { return m_hideScrollBarInFullscreen; }
    void setHideScrollBarInFullscreen(bool hideScrollBarInFullscreen)
    {
        m_hideScrollBarInFullscreen = hideScrollBarInFullscreen;
    }
    ...
    void setHideMouseCursorInFullscreen(bool hideMouseCursorInFullscreen)
    {
        m_hideMouseCursorInFullscreen = hideMouseCursorInFullscreen;
    }
    ...
    void setTopWindowWhenRunWithAssoc(bool topWindowWhenRunWithAssoc)
    {
        m_topWindowWhenRunWithAssoc = topWindowWhenRunWithAssoc;
    }
    bool TopWindowWhenDropped() { return m_topWindowWhenDropped; }
    void setTopWindowWhenDropped(bool topWindowWhenDropped)
    {
        m_topWindowWhenDropped = topWindowWhenDropped;
    }
    ...
    void setScrollWithCursorWhenZooming(bool scrollWithCursorWhenZooming)
    {
        m_scrollWithCursorWhenZooming = scrollWithCursorWhenZooming;
    }
    qvEnums::OptionViewOnStartup ShowOptionViewOnStartup() { return m_showOptionViewOnStartup; }
    void setShowOptionViewOnStartup(qvEnums::OptionViewOnStartup fitMode)
    {
        m_showOptionViewOnStartup = fitMode;
    }
    bool SlideShowOnNormalWindow() { return m_slideShowOnNormalWindow; }
    void setSlideShowOnNormalWindow(bool slideShowOnNormalWindow)
    {
        m_slideShowOnNormalWindow = slideShowOnNormalWindow;
    }
    ...
    void setWideImageAsOnePageInDualView(bool wideImageAsOnePageInDualView)
    {
        m_wideImageAsOnePageInDualView = wideImageAsOnePageInDualView;
    }
    bool FirstImageAsOnePageInDualView() { return m_firstImageAsOnePageInDualView; }
    void setFirstImageAsOnePageInDualView(bool firstImageAsOnePageInDualView)
    {
        m_firstImageAsOnePageInDualView = firstImageAsOnePageInDualView;
    }
    bool SeparatePagesWhenWideImage() { return m_separatePagesWhenWideImage; }
    void setSeparatePagesWhenWideImage(bool separatePagesWhenWideImage)
    {
        m_separatePagesWhenWideImage = separatePagesWhenWideImage;
    }
    ...
    void setRestoreWindowState(bool restoreWindowState)
    {
        m_restoreWindowState = restoreWindowState;
    }
    ...
    void setProhibitMultipleRunning(bool prohibitMultipleRunning)
    {
        m_prohibitMultipleRunning = prohibitMultipleRunning;
    }
    ...
    void setExtractSolidArchiveToTemporaryDir(bool extractSolidArchiveToTemporaryDir)
    {
    ...
    void setLastOpenedFolderPath(QString lastOpenedFolderPath)
    {
        m_lastOpenedFolderPath = lastOpenedFolderPath;
    }
    ...
    void setOpenVolumeWithProgress(bool openVolumeWithProgress)
    {
        m_openVolumeWithProgress = openVolumeWithProgress;
    }
    ...
    void setSaveFolderViewWidth(bool saveFolderViewWidth)
    {
        m_saveFolderViewWidth = saveFolderViewWidth;
    }
    ...
    void setCatalogViewModeSetting(qvEnums::CatalogViewMode catalogViewModeSetting)
    {
        m_catalogViewModeSetting = catalogViewModeSetting;
    }
    QString CatalogDatabasePath();
    void setCatalogDatabasePath(QString catalogDatabasePath)
    {
        m_catalogDatabasePath = catalogDatabasePath;
    }
    int MaxSearchByCharChanged() { return m_maxSearchByCharChanged; }
    void setMaxSearchByCharChanged(int maxSearchByCharChanged)
    {
        m_maxSearchByCharChanged = maxSearchByCharChanged;
    }
    ...
    void setTitleWithoutOptions(bool titleWithoutOptions)
    {
        m_titleWithoutOptions = titleWithoutOptions;
    }
    bool SearchTitleWithOptions() { return m_searchTitleWithOptions; }
    void setSearchTitleWithOptions(bool searchTitleWithOptions)
    {
        m_searchTitleWithOptions = searchTitleWithOptions;
    }
    ...
    void setSaveCatalogViewWidth(bool saveCatalogViewWidth)
    {
        m_saveCatalogViewWidth = saveCatalogViewWidth;
    }
...
private:
    ...
    qvEnums::SvgLoaderBackend m_svgLoaderBackend;
    int m_svgRasterMaximumWidth;
    int m_svgRasterMaximumHeight;
